...
const MovieRecommendations: React.FC = () => {
  ...
  const movies = [
    ...
    },
    {
      ...
      essayContent: `The film explores the concept of family, questioning whether blood relations are more important than emotional connections. One of the most significant themes in Shoplifters is the critique of Japan's social system, which often fails to protect the most vulnerable.`,
    ...
    },
    {
      ...
      essayContent: `Parasite masterfully blends genres, transitioning from dark comedy to thriller, and finally into a harrowing social commentary. Director Bong Joon-ho uses each character in the Kim family as a metaphor for the struggles faced by the working class.`,
    ...
    },
    {
      ...
      essayContent: `Bicycle Thieves is a quintessential example of Italian neorealism, a movement characterized by its focus on the everyday lives of ordinary people, non-professional actors, and location shooting.`,
    ...
    },
    {
      ...
      essayContent: `Park Chan-wook's Oldboy is a film that transcends the typical revenge narrative, blending elements of neo-noir, psychological thriller, and Greek tragedy.`,
    ...
    },
    {
      ...
      essayContent: `Chen Kaige's Farewell My Concubine is a sweeping historical epic that masterfully blends personal tragedy with the political turmoil of 20th-century China.`,
